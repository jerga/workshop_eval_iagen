"""Step 4 - éval LLM-as-a-Judge "en ligne" + remontée des scores dans Langfuse.
...
Si aucune clé Langfuse n'est configurée ou si la ligne n'a pas de trace_id
(ex : dataset d'exemple fourni avec le TP), on calcule quand même les scores
en local sans rien remonter.
"""
...
from eval.step4_production.judge_metrics import (
